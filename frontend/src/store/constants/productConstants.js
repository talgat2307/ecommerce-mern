...
export const RATED_PRODUCT_REQUEST = 'RATED_PRODUCT_REQUEST';
export const RATED_PRODUCT_SUCCESS = 'RATED_PRODUCT_SUCCESS';
export const RATED_PRODUCT_FAIL = 'RATED_PRODUCT_FAIL';
